...
namespace RefactorMe.Core.Infrastructure
{
    ...
    /// <summary>
    /// A class that finds types needed by WebApp by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets whether WebApp should iterate assemblies in the app domain when loading WebApp types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that WebApp assemblies arn't investigated (e.g. by not including something like "^WebApp|..." you may break core functionality.</remarks>
            ...
            try
            {
                foreach (var a in assemblies)
                {
                    ...
                    catch
                    {
                        ...
                        if (!this._ignoreReflectionErrors)
                        {
                            throw;
                        }
                    }
        ...
        /// <returns>A list of assemblies that should be loaded by the WebApp factory.</returns>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into WebApp.
        /// </returns>
